...
function BattleBGM(sound){this.isPlaying=false;
this.sound=sound;
...
BattleSound.bgm;_i18<_BattleSound$bgm.length;_i18++){var bgm=_BattleSound$bgm[_i18];
if(bgm===this){
thisIsFirst=true;
...
this.isPlaying=false;
this.sound.stop();
var soundIndex=BattleSound.bgm.indexOf(this);
if(soundIndex>=0)BattleSound.bgm.splice(soundIndex,1);
BattleBGM.update();
};BattleBGM.
update=function update(){for(var _i19=0,_BattleSound$bgm2=
BattleSound.bgm;_i19<_BattleSound$bgm2.length;_i19++){var bgm=_BattleSound$bgm2[_i19];
if(bgm.isPlaying){
...
bgmVolume=50;this.
muted=false;}var _proto5=_temp.prototype;_proto5.
...
addBgm=function addBgm(sound,replaceBGM){
if(replaceBGM){
