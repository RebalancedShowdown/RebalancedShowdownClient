...
function Species(id,name,data){var _this$forme;this.effectType='Species';
if(!data||typeof data!=='object')data={};
if(data.name)name=data.name;
this.name=Dex.sanitizeName(name);
this.id=id;
...
this.isTotem=false;
this.isMega=false;
this.isGigantamax=!!((_this$forme=this.forme)==null?void 0:_this$forme.endsWith('Gmax'));
this.isPrimal=false;
...
this.hideChatFrom(_user3,true,lineCount);
}
return;
}
case'debug':
...
if(lineCount)nodes=nodes.slice(-lineCount);for(var _i7=0,_nodes=

nodes;_i7<_nodes.length;_i7++){var _node3=_nodes[_i7];
...
unlinkNodeList=function unlinkNodeList(nodeList,classStart){for(var _i8=0,_ref5=
nodeList;_i8<_ref5.length;_i8++){var node=_ref5[_i8];
if(node.className&&(node.className+' ').startsWith(classStart)){
...
if(!parent)continue;for(var _i9=0,_ref6=
linkNode.childNodes;_i9<_ref6.length;_i9++){var childNode=_ref6[_i9];
...
if(attribs[_i10]==='src'&&attribs[_i10+1].substr(0,11)==='data:image/'){
srcIdx=_i10;
dataUri=attribs[_i10+1];
}
if(attribs[_i10]==='src'&&attribs[_i10+1].substr(0,2)==='//'){
if(location.protocol!=='http:'&&location.protocol!=='https:'){
attribs[_i10+1]='http:'+attribs[_i10+1];
}
}
}
...
if(attribs[_i11]==='pokemon'||attribs[_i11]==='item'){

iconAttrib=attribs.slice(_i11,_i11+2);
}else if(attribs[_i11]==='class'){
classValueIndex=_i11+1;
}else if(attribs[_i11]==='style'){
styleValueIndex=_i11+1;
}
}
tagName='span';
