...
var species=BattlePokedex[speciesid];
var baseLearnsetid=species&&toID(species.baseSpecies);
if(!baseLearnsetid){
...
if(learnsetid==='pumpkaboosuper')return'pumpkaboo';

var next=species.battleOnly||species.changesFrom||species.prevo;
...
if(baseSpecies.otherFormes&&baseSpecies.baseSpecies!=='Wormadam'){for(var _i13=0,_baseSpecies$types=
...
if(types.indexOf(BattleMovedex[_id12].type)<0)continue;
if(moves.indexOf(_id12)>=0)continue;
...
throw new Error("invalid sortcol");
};return BattleMoveSearch;}(BattleTypedSearch);BattleMoveSearch.GOOD_STATUS_MOVES=['agility','aromatherapy','auroraveil','autotomize','banefulbunker','batonpass','bellydrum','bulkup','calmmind','clangoroussoul','coil','cottonguard','courtchange','curse','defog','destinybond','detect','disable','dragondance','encore','extremeevoboost','glare','haze','healbell','healingwish','healorder','heartswap','honeclaws','kingsshield','leechseed','lifedew','lightscreen','lovelykiss','magiccoat','maxguard','memento','milkdrink','moonlight','morningsun','nastyplot','naturepower','naturesmadness','noretreat','obstruct','painsplit','partingshot','perishsong','protect','quiverdance','recover','reflect','reflecttype','refresh','rest','roar','rockpolish','roost','shellsmash','shiftgear','slackoff','sleeppowder','sleeptalk','softboiled','spikes','spikyshield','spore','stealthrock','stickyweb','strengthsap','substitute','superfang','switcheroo','swordsdance','synthesis','tailglow','tailwind','taunt','thunderwave','toxic','toxicspikes','transform','trick','whirlwind','willowisp','wish'];BattleMoveSearch.GOOD_WEAK_MOVES=['accelerock','acrobatics','aquajet','avalanche','bonemerang','bouncybubble','bulletpunch','bulletseed','buzzybuzz','circlethrow','clearsmog','doubleironbash','dragondarts','dragontail','endeavor','facade','firefang','freezedry','frustration','geargrind','grassknot','gyroball','heavyslam','hex','icefang','iceshard','iciclespear','knockoff','lowkick','machpunch','nightshade','nightslash','pikapapow','psychocut','pursuit','quickattack','rapidspin','return','rockblast','rocktomb','seismictoss','shadowclaw','shadowpunch','shadowsneak','sizzlyslide','storedpower','stormthrow','suckerpunch','tailslap','uturn','veeveevolley','voltswitch','watershuriken','weatherball'];BattleMoveSearch.BAD_STRONG_MOVES=['appleacid','beakblast','belch','burnup','crushclaw','doomdesire','dragonrush','dreameater','eggbomb','firepledge','flyingpress','futuresight','grasspledge','gravapple','hyperfang','hyperspacehole','jawlock','landswrath','lastresort','lightthatburnsthesky','megakick','megapunch','muddywater','mysticalfire','nightdaze','pollenpuff','rockclimb','seedflare','selfdestruct','shelltrap','skyuppercut','slam','snipeshot','strength','submission','synchronoise','takedown','thrash','uproar','waterpledge'];BattleMoveSearch.GOOD_DOUBLES_MOVES=['allyswitch','bulldoze','electroweb','faketears','fling','followme','healpulse','helpinghand','muddywater','pollenpuff','psychup','ragepowder','safeguard','skillswap','wideguard','yawn'];var
