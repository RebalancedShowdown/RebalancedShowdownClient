...
<?php } ?>
	...
	<link rel="stylesheet" href="//play.pokemonshowdown.com/style/battle.css?722692a7" />
...
<?php $panels->scripts(); ?>
	...
	<script src="//play.pokemonshowdown.com/config/config.js?4bf05ee3"></script>
	<script src="//play.pokemonshowdown.com/js/battledata.js?1978d356"></script>
	<script src="//play.pokemonshowdown.com/data/pokedex-mini.js?8e2d399f"></script>
	<script src="//play.pokemonshowdown.com/data/pokedex-mini-bw.js?bda8ff64"></script>
	<script src="//play.pokemonshowdown.com/data/graphics.js?5121293d"></script>
	<script src="//play.pokemonshowdown.com/data/pokedex.js?5e44f009"></script>
	<script src="//play.pokemonshowdown.com/data/items.js?a909760a"></script>
	<script src="//play.pokemonshowdown.com/data/moves.js?07305500"></script>
	<script src="//play.pokemonshowdown.com/data/abilities.js?869232aa"></script>
	<script src="//play.pokemonshowdown.com/data/teambuilder-tables.js?a953a2bc"></script>
	<script src="//play.pokemonshowdown.com/js/battle-tooltips.js?bf3116ce"></script>
	<script src="//play.pokemonshowdown.com/js/battle.js?385d701f"></script>
	<script src="/js/replay.js?19ccdcb7"></script>
